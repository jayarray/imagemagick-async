...
class BilinearCanvas extends CanvasBaseClass {
  constructor(builder) {
    super(builder);
  }
  ...
  Args() {
    ...
    let args = ['-size', `${this.args.width}x${this.args.height}`, 'canvas:', '-colorspace', 'RGB', '-sparse-color', 'Bilinear', stringArr.join(' ')];
   ...
   */
  Errors() {
    let params = BilinearCanvas.Parameters();
    let errors = [];
    let prefix = 'BILINEAR_CANVAS_ERROR';
...
exports.BilinearCanvas = BilinearCanvas;