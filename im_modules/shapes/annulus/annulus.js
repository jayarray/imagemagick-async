...
let ELLIPSE = require(PATH.join(rootDir, 'im_modules', 'primitives', 'ellipse', 'ellipse.js')).Create;
let CIRCLE = require(PATH.join(rootDir, 'im_modules', 'primitives', 'circle', 'circle.js')).Create;
